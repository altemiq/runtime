...
public static class YamlConfigurationExtensions
{
    ...
    /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
    public static IConfigurationBuilder AddYamlFile(this IConfigurationBuilder builder, Action<Altemiq.Extensions.Configuration.Yaml.YamlConfigurationSource>? configureSource)
