// -----------------------------------------------------------------------
// <copyright file="BitTreeEncoder.cs" company="Altemiq">
...
internal readonly struct BitTreeEncoder(int bitLevels)
{
    private readonly BitEncoder[] models = new BitEncoder[1 << bitLevels];
    ...
    {
        var m = 1U;
        for (var bitIndex = bitLevels - 1; bitIndex > -1; bitIndex--)
        {
