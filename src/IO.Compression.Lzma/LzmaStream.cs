// -----------------------------------------------------------------------
// <copyright file="LzmaStream.cs" company="Altemiq">
...
public sealed class LzmaStream : Stream
{
    ...
    public LzmaStream(Stream stream, CompressionMode mode, bool leaveOpen = false)
    {
        ...
        switch (mode)
        {
            case CompressionMode.Compress when this.stream.CanWrite:
                this.encoder = new LzmaCompressionOptions().CreateEncoder();
                this.encoder.WriteCoderProperties(this.stream);
                break;
            case CompressionMode.Decompress when this.stream.CanRead:
    ...
    public void CopyFrom(Stream destination)
    {
        ...
        this.SetLength(destination.Length);
        this.encoder.Compress(destination, this.stream);
    }
