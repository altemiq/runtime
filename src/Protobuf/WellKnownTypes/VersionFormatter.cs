...
internal sealed class VersionFormatter : IFormatProvider, ICustomFormatter
{
    ...
    /// <inheritdoc/>
    public object? GetFormat(System.Type? formatType) => formatType == typeof(ICustomFormatter) || typeof(SemanticVersion).GetTypeInfo().IsAssignableFrom(formatType?.GetTypeInfo()) ? this : default;
