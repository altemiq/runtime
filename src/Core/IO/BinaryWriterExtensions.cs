...
public static class BinaryWriterExtensions
{
...
#else
                System.Buffers.Binary.BinaryPrimitives.WriteInt32BigEndian(buffer, System.BitConverter.SingleToInt32Bits(value));
#endif
                writer.BaseStream.Write(buffer);
                return;
            }
...
#else
                System.Buffers.Binary.BinaryPrimitives.WriteInt64BigEndian(buffer, System.BitConverter.DoubleToInt64Bits(value));
#endif
                writer.BaseStream.Write(buffer);
                return;
            }
    ...
    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    private static double ReverseEndianness(double value) => System.BitConverter.Int64BitsToDouble(Buffers.Binary.BinaryPrimitives.ReverseEndianness(System.BitConverter.DoubleToInt64Bits(value)));
#endif
