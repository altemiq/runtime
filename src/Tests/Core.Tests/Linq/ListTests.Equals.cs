...
public partial class ListTests
{
    ...
    {
        TestListList<int, bool>(first, second, (f, s) => f.Equals(1, s, 0, s.Count), true).Should().BeTrue();
        TestListReadOnlyList<int, bool>(first, second, (f, s) => f.Equals(1, s, 0, s.Count), true).Should().BeTrue();
        TestReadOnlyListList<int, bool>(first, second, (f, s) => f.Equals(1, s, 0, s.Count), true).Should().BeTrue();
        TestReadOnlyListReadOnlyList<int, bool>(first, second, (f, s) => f.Equals(1, s, 0, s.Count), true).Should().BeTrue();
    }
    ...
    {
        TestListList<int, bool>(first, second, (f, s) => f.Equals(2, s, 0, s.Count), false).Should().BeFalse();
        TestListReadOnlyList<int, bool>(first, second, (f, s) => f.Equals(2, s, 0, s.Count), false).Should().BeFalse();
        TestReadOnlyListList<int, bool>(first, second, (f, s) => f.Equals(2, s, 0, s.Count), false).Should().BeFalse();
        TestReadOnlyListReadOnlyList<int, bool>(first, second, (f, s) => f.Equals(2, s, 0, s.Count), false).Should().BeFalse();
    }
