...
public static class ProtobufBuilderExtensions
{
    ...
    public static Caching.Hybrid.IHybridCacheBuilder AddProtobufSerializer<T>(this Caching.Hybrid.IHybridCacheBuilder builder)
    ...
    public static Caching.Hybrid.IHybridCacheBuilder AddProtobufSerializerFactory(this Caching.Hybrid.IHybridCacheBuilder builder) => builder.AddSerializerFactory<Altemiq.Extensions.Caching.Hybrid.Internal.ProtobufSerializerFactory>();
}